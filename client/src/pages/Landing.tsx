    ...
    <div className="min-h-screen bg-background">
      <header className="border-b">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-xl font-bold">HealthID Nexus</h1>
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="mt-24 mb-16">
          <h3 className="text-3xl font-bold text-center mb-12">About HealthID Nexus</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-4">
              <p className="text-lg text-muted-foreground">
                HealthID Nexus is a revolutionary blockchain-based healthcare identity platform designed to address the unique challenges of African healthcare systems. Our mission is to ensure that every individual has access to their medical records when and where they need them most.
              </p>
              <p className="text-lg text-muted-foreground">
      ...
      <footer className="border-t mt-16 bg-muted/30">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-bold">HealthID Nexus</h3>
              </div>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="border-t pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-muted-foreground">
              HealthID Nexus - Built on BlockDAG | Secure • Decentralized • Patient-Owned
            </p>
            <p className="text-sm text-muted-foreground">
              © 2025 HealthID Nexus. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
