...
import { ClipboardList, CheckCircle, XCircle, Clock, DollarSign, TrendingUp } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="hover-elevate cursor-pointer" onClick={() => setLocation("/insurance/claims")}>
          <CardHeader>
        ...
        <Card className="hover-elevate cursor-pointer" onClick={() => setLocation("/insurance/policies")}>
          <CardHeader>
        ...
        <Card className="hover-elevate cursor-pointer" onClick={() => setLocation("/insurance/analytics")}>
          <CardHeader>
